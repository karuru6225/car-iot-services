...
```json
{"state":{"reported":{"ah_offset":200,"chg_start_v":11.70,"chg_stop_v":12.50,"chg_min_diff_v":0.30,"debug_log":false,"charging":false,"override_next_mode":null,"continuous_until_time":null,"default_mode":null,"fw_version":"1.25.0+xxxxxxxx"}}}
```
